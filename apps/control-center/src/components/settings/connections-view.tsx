...
import { Youtube, Info, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6 max-w-xl">
      ...
      <div className="rounded-lg border border-border p-4">
        ...
        <button onClick={save} className="mt-4 flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground">
