  ...
  return (
    <div
      className={cn(
        ...
        props.tone ?? "bg-muted text-muted-foreground border-border",
      )}
      title={props.title}
    >
...
export function SettingsPanelToolbarMessage(props: SettingsPanelToolbarMessageProps) {
  return <div className="text-xs leading-relaxed text-muted-foreground md:max-w-sm">{props.children}</div>;
}
